...
implements JPaymentInterface {
    ...
    public JPaymentCashPos(JPaymentNotifier notifier, DataLogicSystem dlSystem) {
        ...
        payment.addImageButton("m50", 50.0);
        payment.addImageButton("m100", 100.0);
        payment.addImageButton("m200", 200.0);
        payment.addImageButton("m500", 500.0);
        payment.addImageButton("m1000", 1000.0);
        payment.addImageButton("b1000", 1000.0);
        payment.addImageButton("b2000", 2000.0);
        payment.addImageButton("b5000", 5000.0);
        payment.addImageButton("b10000", 10000.0);
        payment.addImageButton("b20000", 20000.0);
        payment.addImageButton("b50000", 50000.0);
        payment.addImageButton("b100000", 100000.0);
    }
    ...
    public class ScriptPaymentCash {
        ...
        public void addImageButton(String imageName, double amount) {
            ...
            URL imgUrl = this.getClass().getResource("/com/openbravo/images/" + imageName + ".png");
            if (imgUrl != null) {
