...
/* Header line. Object: audit_lines. Script date: 2025/12/25. */
...
CREATE TABLE attributeuse (
	...
	CONSTRAINT attuse_line UNIQUE ( attributeset_id, lineno ),
	PRIMARY KEY  ( id )
) 
...
CREATE TABLE categories (
	...
	CONSTRAINT categories_name_inx UNIQUE ( name ),
	PRIMARY KEY  ( id )
) 
...
CREATE TABLE closedcash (
	...
	nosales integer NOT NULL default '0',
...
CREATE TABLE floors (
	...
	name varchar(255) NOT NULL,
	image blob default NULL,
	CONSTRAINT floors_name_inx UNIQUE ( name ),
	PRIMARY KEY  ( id )
) 
...
CREATE TABLE locations (
	...
	name varchar(255) NOT NULL,
	address varchar(255) default NULL,
	CONSTRAINT locations_name_inx UNIQUE ( name ),
	PRIMARY KEY  ( id )
) 
...
/* Header line. Object: payment_categories. Script date: 11/02/2026. */
...
CREATE TABLE places (
	...
	CONSTRAINT places_name_inx UNIQUE ( name ),
	PRIMARY KEY  ( id )
) 
...
CREATE TABLE products (
	...
	CONSTRAINT products_inx_0 UNIQUE ( reference ),
	CONSTRAINT products_inx_1 UNIQUE ( code )) 
...
CREATE TABLE products_bundle (
    ...
    PRIMARY KEY ( id ),
    CONSTRAINT pbundle_inx_prod UNIQUE ( product , product_bundle )
) 
...
CREATE TABLE products_com (
	...
	CONSTRAINT pcom_inx_prod UNIQUE ( product, product2 ),
	PRIMARY KEY  ( id )) 
...
CREATE TABLE reservations (
	...
	datenew timestamp NOT NULL default '2015-01-01 00:00:00',
...
CREATE TABLE resources (
	...
	PRIMARY KEY  ( id ),
	CONSTRAINT resources_name_inx UNIQUE ( name )
) 
...
CREATE TABLE roles (
	...
	PRIMARY KEY  ( id ),
	CONSTRAINT roles_name_inx UNIQUE ( name )
) 
...
CREATE TABLE stockcurrent (
	...
	CONSTRAINT stockcurrent_inx UNIQUE ( location, product, attributesetinstance_id )
) 
...
CREATE TABLE suppliers (
	...
	CONSTRAINT suppliers_skey_inx UNIQUE ( searchkey )
) 
...
CREATE TABLE taxcategories (
	...
	name varchar(255) NOT NULL,
	PRIMARY KEY  ( id ),
	CONSTRAINT taxcat_name_inx UNIQUE ( name )
) 
...
CREATE TABLE taxcustcategories (
	...
	name varchar(255) NOT NULL,
	PRIMARY KEY  ( id ),
	CONSTRAINT taxcustcat_name_inx UNIQUE ( name )
) 
...
CREATE TABLE thirdparties (
	...
	notes varchar(255) default NULL,
	PRIMARY KEY  ( id ),
	CONSTRAINT thirdparties_cif_inx UNIQUE ( cif ),
	CONSTRAINT thirdparties_name_inx UNIQUE ( name )
) 
...
/* Header line. Object: electronic invoicing ticket numbers. Script date: 11/02/2026. */
CREATE TABLE ticketsnum_fe (
	id integer NOT NULL
) 

CREATE TABLE ticketsnum_pose (
	id integer NOT NULL
) 

CREATE TABLE ticketsnum_docs (
	id integer NOT NULL
) 

CREATE TABLE ticketsnum_noc (
	id integer NOT NULL
) 
...
INSERT INTO roles(id, name, permissions) VALUES('4', 'Maestro role', $FILE{/com/openbravo/pos/templates/Role.Administrator.xml} );
...
INSERT INTO people(id, name, apppassword, role, visible, image) VALUES ('4', 'maestro', NULL, '4', 1, NULL);
...
INSERT INTO taxcategories(id, name) VALUES ('001', 'Estándar 19%');
INSERT INTO taxcategories(id, name) VALUES ('002', 'Reducido 5%');
INSERT INTO taxcategories(id, name) VALUES ('003', 'Impoconsumo');

-- ADD TAXES
-- Exento
INSERT INTO taxes(id, name, category, custcategory, parentid, rate, ratecascade, rateorder) VALUES ('000', 'Exento', '000', NULL, NULL, 0, 0, NULL);
-- IVA 19% (Standard)
INSERT INTO taxes(id, name, category, custcategory, parentid, rate, ratecascade, rateorder) VALUES ('001', 'IVA_19', '001', NULL, NULL, 0.19, 0, NULL);
-- IVA 5%
INSERT INTO taxes(id, name, category, custcategory, parentid, rate, ratecascade, rateorder) VALUES ('002', 'IVA_5', '002', NULL, NULL, 0.05, 0, NULL);
-- INC (Impoconsumo 8%)
INSERT INTO taxes(id, name, category, custcategory, parentid, rate, ratecascade, rateorder) VALUES ('003', 'INC', '003', NULL, NULL, 0.08, 0, NULL);
-- Placeholder for Regionals (ICA, ICC...)
INSERT INTO taxes(id, name, category, custcategory, parentid, rate, ratecascade, rateorder) VALUES ('004', 'ICA', '000', NULL, NULL, 0.00, 0, NULL);
INSERT INTO taxes(id, name, category, custcategory, parentid, rate, ratecascade, rateorder) VALUES ('005', 'ICUI', '000', NULL, NULL, 0.00, 0, NULL);
