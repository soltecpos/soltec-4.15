...
public class CodesTMU220
extends Codes {
    private static final byte[] INITSEQUENCE = new byte[0];
    public static final byte[] CHAR_SIZE_0 = new byte[]{27, 33, 1};
    public static final byte[] CHAR_SIZE_1 = new byte[]{27, 33, 17};
    public static final byte[] CHAR_SIZE_2 = new byte[]{27, 33, 33};
    public static final byte[] CHAR_SIZE_3 = new byte[]{27, 33, 49};
