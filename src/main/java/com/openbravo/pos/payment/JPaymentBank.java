...
public class JPaymentBank
extends JPanel
implements JPaymentInterface {
    private JPaymentNotifier m_notifier;
    private double m_dPaid;
    private double m_dTotal;
    private String m_sPaymentName;
    ...
    public JPaymentBank(JPaymentNotifier notifier, String paymentName) {
        this.m_notifier = notifier;
        this.m_sPaymentName = paymentName;
        this.initComponents();
    ...
    public PaymentInfo executePayment() {
        return new PaymentInfoTicket(this.m_dPaid, this.m_sPaymentName);
    }
