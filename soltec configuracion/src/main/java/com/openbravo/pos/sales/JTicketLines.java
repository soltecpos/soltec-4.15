...
extends JPanel {
    ...
    public void refreshTableModel() {
        this.m_jTableModel.fireTableDataChanged();
    }
    ...
    extends AbstractTableModel {
        ...
        private final ArrayList<TicketLineInfo> m_lines = new ArrayList<>();
        ...
        public TicketLineInfo getRow(int row) {
            return this.m_lines.get(row);
        }
        ...
        public void insertRow(int index, TicketLineInfo oLine) {
            ...
            this.m_lines.add(index, oLine);
            this.fireTableRowsInserted(index, index);
        }

        public void removeRow(int row) {
            this.m_rows.remove(row);
            this.m_lines.remove(row);
    ...
    extends DefaultTableCellRenderer {
        ...
        public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
            ...
            TicketLineInfo lineInfo = model.getRow(row);
            
            if (lineInfo != null) {
                if (column == 0) {
                    System.out.println("DEBUG RENDERER row=" + row + " product=" + lineInfo.getProductName() + " sendstatus=" + lineInfo.getProperty("sendstatus") + " selected=" + isSelected);
                }
                if ("Yes".equals(lineInfo.getProperty("sendstatus"))) {
                    if (isSelected) {
                        aux.setBackground(new Color(255, 200, 100)); // Darker orange selection
                    } else {
                        aux.setBackground(new Color(255, 235, 205)); // Subtle orange unselected
                    }
