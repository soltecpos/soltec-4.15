    ...
    public static Session createSession(AppProperties props) throws BasicException {
        try {
            ...
            if (props.getProperty("db.driver") == null) {
                throw new BasicException("Database Driver is not defined in configuration (db.driver is null).");
            }
            if (dbURL == null) {
                throw new BasicException("Database URL is not defined in configuration (db.URL is null).");
            }
