...
REM    Copyright (c) 2009-2017 SmartPos
...
start /B javaw -Xms512m -Xmx1024m -cp %CP% -Djava.library.path="%DIRNAME%lib/Windows/i368-mingw32" -Ddirname.path="%DIRNAME%./" -splash:smartpos_splash_dark.png com.openbravo.pos.forms.StartPOS %1