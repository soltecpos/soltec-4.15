...
CREATE TABLE `payment_categories` (
	`id` varchar(255) NOT NULL,
	`name` varchar(255) NOT NULL,
	`is_global` bit(1) NOT NULL default b'0',
	PRIMARY KEY  ( `id` )
) ENGINE = InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT = Compact;
...
-- IVA 19% (Standard)
INSERT INTO taxes(id, name, category, custcategory, parentid, rate, ratecascade, rateorder) VALUES ('001', 'IVA_19', '001', NULL, NULL, 0.19, FALSE, NULL);
-- IVA 5%
INSERT INTO taxes(id, name, category, custcategory, parentid, rate, ratecascade, rateorder) VALUES ('002', 'IVA_5', '002', NULL, NULL, 0.05, FALSE, NULL);
-- INC (Impoconsumo 8%)
INSERT INTO taxes(id, name, category, custcategory, parentid, rate, ratecascade, rateorder) VALUES ('003', 'INC', '003', NULL, NULL, 0.08, FALSE, NULL);
-- Placeholder for Regionals (ICA, ICC...)
INSERT INTO taxes(id, name, category, custcategory, parentid, rate, ratecascade, rateorder) VALUES ('004', 'ICA', '000', NULL, NULL, 0.00, FALSE, NULL);
INSERT INTO taxes(id, name, category, custcategory, parentid, rate, ratecascade, rateorder) VALUES ('005', 'ICUI', '000', NULL, NULL, 0.00, FALSE, NULL);
