...
extends JDialog {
    ...
    private JProductAttEdit1(Frame parent, boolean modal) {
        super(parent, modal);
    }

    private JProductAttEdit1(Dialog parent, boolean modal) {
        super(parent, modal);
    }
    ...
    public static JProductAttEdit1 getAttributesEditor(Component parent, Session s) {
        ...
        JProductAttEdit1 myMsg = window instanceof Frame ? new JProductAttEdit1((Frame)window, true) : new JProductAttEdit1((Dialog)window, true);
        myMsg.init(s);
    ...
    private void initComponents() {
        ...
        this.m_jButtonCancel.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent evt) {
                JProductAttEdit1.this.m_jButtonCancelActionPerformed(evt);
            }
        });
        ...
        this.m_jButtonOK.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                JProductAttEdit1.this.m_jButtonOKActionPerformed(evt);
            }
        });
