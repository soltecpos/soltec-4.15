...
#    Copyright (C) 2009-2017 SmartPos
...
# start SmartPOS
java -cp $CP -Xms512m -Xmx1024m -splash:smartpos_splash_dark.png -Djava.library.path=$DIRNAME$LIBRARYPATH -Ddirname.path=$DIRNAME/ com.openbravo.pos.forms.StartPOS