...
implements ReportEditorCreator {
    ...
    private void initComponents() {
        ...
        this.m_jReference1.setFont(new Font("Arial", 0, 12));
        ...
        this.m_jSearch.setPreferredSize(new Dimension(70, 30));
        this.m_jSearch.setRequestFocusEnabled(false);
        this.m_jSearch.addActionListener(new ActionListener(){

            @Override
            public void actionPerformed(ActionEvent evt) {
                AuxiliarFilter.this.m_jSearchActionPerformed(evt);
            }
        });
        ...
        layout.setHorizontalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addContainerGap().addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addComponent(this.jLabel6, -2, -1, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.m_jReference1, -2, -1, -2)).addComponent(this.m_jSearch, -2, 260, -2)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.search, -2, -1, -2).addGroup(layout.createSequentialGroup().addComponent(this.Enter1, -2, -1, -2).addGap(22, 22, 22).addComponent(this.jLabel7, -2, -1, -2).addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addComponent(this.m_jBarcode1, -2, -1, -2).addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addComponent(this.Enter2, -2, -1, -2))).addContainerGap()));
        layout.setVerticalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addContainerGap().addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.m_jBarcode1, -2, -1, -2).addComponent(this.jLabel7, -2, -1, -2)).addGroup(layout.createSequentialGroup().addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.Enter2, -2, -1, -2).addComponent(this.Enter1, -2, -1, -2).addGroup(layout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.jLabel6, -2, -1, -2).addComponent(this.m_jReference1, -2, -1, -2))).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.search, -2, -1, -2).addComponent(this.m_jSearch, -2, -1, -2)))).addContainerGap()));
